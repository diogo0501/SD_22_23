...
tree-server: $(BASE_OBJECTS) tree_skel.o network_server.o tree_server.o
	$(CC) -g $(addprefix $(OBJECTDIR)/,$(BASE_OBJECTS)) $(OBJECTDIR)/tree_server.o $(OBJECTDIR)/tree.o $(OBJECTDIR)/sdmessage.pb-c.o /usr/local/lib/libprotobuf-c.a $(OBJECTDIR)/network_server.o $(OBJECTDIR)/network_client.o $(OBJECTDIR)/tree_skel.o -o $(BINARYDIR)/tree-server -lpthread
