...
BASE_OBJECTS = data.o entry.o message-private.o serialization.o
...
tree-server: $(BASE_OBJECTS) tree_skel.o network_server.o tree_server.o
	$(CC) -D THREADED -g $(addprefix $(OBJECTDIR)/,$(BASE_OBJECTS)) $(OBJECTDIR)/tree_server.o $(OBJECTDIR)/tree.o $(OBJECTDIR)/sdmessage.pb-c.o /usr/local/lib/libprotobuf-c.a $(OBJECTDIR)/network_server.o $(OBJECTDIR)/network_client.o $(OBJECTDIR)/tree_skel.o -o $(BINARYDIR)/tree-server -lpthread -lzookeeper_mt

tree-client: $(BASE_OBJECTS) client-lib.o tree_client.o
	$(CC) -D THREADED -g $(addprefix $(OBJECTDIR)/,$(BASE_OBJECTS)) $(OBJECTDIR)/tree_client.o $(OBJECTDIR)/tree.o $(LIBDIR)/client-lib.o /usr/local/lib/libprotobuf-c.a -o $(BINARYDIR)/tree-client -lzookeeper_mt
